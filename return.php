...
<html>
    ...
    <body>
        <div id="main">
            ...
            echo '<html><h1>Return Books</h1></html>';
            ?>
            <?php
            $ret_msg = "Book was Returned Successfully!";
            if (isset($_SESSION['ret'])) {
                echo "<div class='upmsg'>" . $ret_msg . "</div>";
                unset($_SESSION['ret']);
            }
            ?>
            <?php
            $ren_msg = "Book was Returned Successfully!";
            if (isset($_SESSION['ren'])) {
                echo "<div class='upmsg'>" . $ren_msg . "</div>";
                unset($_SESSION['ren']);
            }
            ?>
            ...
            <div><center><h2>List of Books to be Returned</h2></center></div>
            <?php
            ...
            if ($bookName . null) {
//                $sql = "SELECT * FROM `issued_books` WHERE MATCH (`bookName`) AGAINST ('$bookName' IN NATURAL LANGUAGE MODE)";
                $sql = "SELECT * FROM `issued_books` WHERE `bookName` LIKE '%$bookName%'";
            } else {
...
//            while ($row = mysqli_fetch_assoc($result))
            ...
            <div class="table-responsive">
                <table class="table table-centered datatable dt-responsive nowrap" data-page-length="10" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                    <thead>
                        <tr>
                            <th><center>Book Id</center></th>
                    <th><center>Issuer</center></th>
                    ...
                    <tbody>
                        <?php if (mysqli_num_rows($result) > 0) { ?>
                            ...
                            <td><center><?php echo $row["Issuer"]; ?></center></td>
                            ...
                            <td>
                                <div class="action">
                                    <a href="returnAction.php?id='<?php echo $row["bookID"]; ?>'"> <img src="https://img.icons8.com/ios-filled/50/000000/return-book.png" width="25px"/> </a>
                                    <a href="renewAction.php?id='<?php echo $row["bookID"]; ?>'"> <img src="https://img.icons8.com/wired/64/000000/renew-subscription.png" width="25px"/> </a>
                                </div>
                            </td>
                            <td><center><?php
                                $ret = $row["issueDate"];
                                $sql1 = "SELECT DATEDIFF('$now','$ret') as date_difference";
...
//                                
                                ?></center></td>
        <!--                            <td><center><button type="submit"  name="search" value="Search" class="btn btn-success btn-edit"><img src="https://img.icons8.com/windows/32/000000/event-accepted-tentatively.png"/></button></center></td>	-->
                            </tr>
                        <?php } ?>
                    <?php } ?>
                    </tbody>
        ...
        <div id="mySidenav" class="sidenav">
            ...
            <a href="issue.php">Return Books</a>
