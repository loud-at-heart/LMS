...
<html>
    ...
    <body>
        <div id="main">
            ...
            echo '<html><h1>Issue Books</h1></html>';
            ?>
            <?php
            $up_msg = "Book was Issued Successfully!";
...
//                $sql = "SELECT * FROM books WHERE MATCH (`bookName`,`bookAuthor`) AGAINST ('$bookName' IN NATURAL LANGUAGE MODE) AND `Availibility`='Yes'";
            ...
            <div class="table-responsive">
                <table id="issuable_table" class="table table-bordered table-striped">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <?php if (mysqli_num_rows($result) > 0) { ?>
                            ...
                            <td>
                                <div class="action">
                                    <a href="issueAction.php?id='<?php echo $row["bookID"]; ?>'"> <img src="https://img.icons8.com/windows/32/000000/event-accepted-tentatively.png" width="25px"> </a>
                                </div>
                            </td>
